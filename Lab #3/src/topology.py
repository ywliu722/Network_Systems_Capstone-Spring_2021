...
def runBGP(routers):
    ...
    routers['r1'].cmd('bgpd -f ./configs/r1quagga.conf -d -i /var/run/quagga/bgpdr1.pid')
    routers['r2'].cmd('zebra -f ./configs/zebra.conf -d -i /var/run/quagga/zebrar2.pid')
    routers['r2'].cmd('bgpd -f ./configs/r2quagga.conf -d -i /var/run/quagga/bgpdr2.pid')
    routers['r3'].cmd('zebra -f ./configs/zebra.conf -d -i /var/run/quagga/zebrar3.pid')
    routers['r3'].cmd('bgpd -f ./configs/r3quagga.conf -d -i /var/run/quagga/bgpdr3.pid')
    routers['r4'].cmd('zebra -f ./configs/zebra.conf -d -i /var/run/quagga/zebrar4.pid')
    routers['r4'].cmd('bgpd -f ./configs/r4quagga.conf -d -i /var/run/quagga/bgpdr4.pid')
